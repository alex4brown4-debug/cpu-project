    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_cpu_pipeline_top__reg_file_i->varInsert("regs", &(TOP.cpu_pipeline_top__DOT__reg_file_i__DOT__regs), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RD, 1, 1 ,0,31 ,31,0);
}
