...
class alignas(VL_CACHE_LINE_BYTES) Vcpu_pipeline_top___024root final {
  public:
    ...
    IData/*22:0*/ cpu_pipeline_top__DOT__id_ctrl;
    ...
    IData/*31:0*/ cpu_pipeline_top__DOT__reg_file_i__DOT__rd_data;
    IData/*31:0*/ cpu_pipeline_top__DOT__imm_gen_i__DOT__imm;
    IData/*31:0*/ __VactIterCount;
    VlWide<4>/*96:0*/ cpu_pipeline_top__DOT__if_id_q;
    VlWide<8>/*230:0*/ cpu_pipeline_top__DOT__id_ex_q;
    VlWide<7>/*220:0*/ cpu_pipeline_top__DOT__ex_mem_d;
    VlWide<7>/*220:0*/ cpu_pipeline_top__DOT__ex_mem_q;
    VlWide<10>/*292:0*/ cpu_pipeline_top__DOT__mem_wb_d;
    VlWide<10>/*292:0*/ cpu_pipeline_top__DOT__mem_wb_q;
