...
void Vcpu_single_cycle_top___024root__trace_chg_0_sub_0(Vcpu_single_cycle_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgIData(oldp+5,(vlSelfRef.cpu_single_cycle_top__DOT__ctrl),25);
    ...
    bufp->chgBit(oldp+34,(vlSelfRef.perf_stall));
    bufp->chgBit(oldp+35,(vlSelfRef.perf_flush));
    bufp->chgIData(oldp+36,(vlSelfRef.cpu_single_cycle_top__DOT__reg_file_i__DOT__regs
                            [(0x0000001fU & (vlSelfRef.instr_out 
                                             >> 0x0000000fU))]),32);
    bufp->chgIData(oldp+37,(vlSelfRef.cpu_single_cycle_top__DOT__reg_file_i__DOT__regs
                            [(0x0000001fU & (vlSelfRef.instr_out 
                                             >> 0x00000014U))]),32);
    bufp->chgBit(oldp+38,(((vlSelfRef.cpu_single_cycle_top__DOT__ctrl 
                            >> 7U) & ((0x00000040U 
                                           ...
                                           : ((0x00000010U 
                                               ...
                                               : (vlSelfRef.cpu_single_cycle_top__DOT__reg_file_i__DOT__regs
                                                  ...
                                                  (0x0000001fU 
                                                   & (vlSelfRef.instr_out 
                                                      >> 0x00000014U))])))))));
    bufp->chgBit(oldp+39,(((0x00000040U & vlSelfRef.cpu_single_cycle_top__DOT__ctrl)
                            ? ((~ (vlSelfRef.cpu_single_cycle_top__DOT__ctrl 
                                   >> 5U)) & ((0x00000010U 
                                               & vlSelfRef.cpu_single_cycle_top__DOT__ctrl)
                                               ? (vlSelfRef.cpu_single_cycle_top__DOT__reg_file_i__DOT__regs
                                ...
                                : ((0x00000010U & vlSelfRef.cpu_single_cycle_top__DOT__ctrl)
                                    ...
                                    : (vlSelfRef.cpu_single_cycle_top__DOT__reg_file_i__DOT__regs
                                       ...
                                       [(0x0000001fU 
                                         & (vlSelfRef.instr_out 
                                            >> 0x00000014U))]))))));
    bufp->chgIData(oldp+40,(((4U & vlSelfRef.cpu_single_cycle_top__DOT__ctrl)
                              ? vlSelfRef.cpu_single_cycle_top__DOT__reg_file_i__DOT__regs
                             [(0x0000001fU & (vlSelfRef.instr_out 
                                              >> 0x0000000fU))]
                              : vlSelfRef.cpu_single_cycle_top__DOT__pc)),32);
    bufp->chgBit(oldp+41,((1U & ((vlSelfRef.cpu_single_cycle_top__DOT__ctrl 
    ...
    bufp->chgCData(oldp+42,((0x0000001fU & (vlSelfRef.instr_out 
                                            >> 0x0000000fU))),5);
    bufp->chgCData(oldp+43,((0x0000001fU & (vlSelfRef.instr_out 
                                            >> 0x00000014U))),5);
    bufp->chgCData(oldp+44,((0x0000001fU & (vlSelfRef.instr_out 
                                            >> 7U))),5);
    Vcpu_single_cycle_top___024root__trace_chg_dtype____0(vlSelf, bufp, 45, vlSelfRef.cpu_single_cycle_top__DOT__reg_file_i__DOT__regs);
}
