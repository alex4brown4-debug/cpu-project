...
class alignas(VL_CACHE_LINE_BYTES) Vcpu_pipeline_top___024root final {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ cpu_pipeline_top__DOT__update_valid;
        CData/*0:0*/ cpu_pipeline_top__DOT__predict_taken;
        CData/*0:0*/ cpu_pipeline_top__DOT__rvfi_rd_written;
        CData/*5:0*/ cpu_pipeline_top__DOT__predictor_i__DOT__ghr;
        CData/*7:0*/ cpu_pipeline_top__DOT__predictor_i__DOT__index;
        CData/*7:0*/ cpu_pipeline_top__DOT__predictor_i__DOT__upd_index;
        ...
        IData/*31:0*/ cpu_pipeline_top__DOT__predict_target;
        IData/*24:0*/ cpu_pipeline_top__DOT__id_ctrl;
        IData/*31:0*/ cpu_pipeline_top__DOT__mem_alu_result;
        IData/*31:0*/ cpu_pipeline_top__DOT__predictor_i__DOT__pred_imm_gen__DOT__imm;
        ...
        VlUnpacked<CData/*1:0*/, 256> cpu_pipeline_top__DOT__predictor_i__DOT__predictor_state;
