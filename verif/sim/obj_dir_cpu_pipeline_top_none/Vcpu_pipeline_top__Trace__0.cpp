...
void Vcpu_pipeline_top___024root__trace_chg_0_sub_0(Vcpu_pipeline_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgBit(oldp+57,((3U == (3U & (vlSelfRef.cpu_pipeline_top__DOT__mem_wb_q[9U] 
                                            >> 5U)))));
        bufp->chgIData(oldp+58,(vlSelfRef.cpu_pipeline_top__DOT__branch_cmp_i__DOT__rs1),32);
        bufp->chgIData(oldp+59,(vlSelfRef.cpu_pipeline_top__DOT__branch_cmp_i__DOT__rs2),32);
        bufp->chgIData(oldp+60,(vlSelfRef.cpu_pipeline_top__DOT__alu_i__DOT__a),32);
        bufp->chgIData(oldp+61,(vlSelfRef.cpu_pipeline_top__DOT__alu_i__DOT__b),32);
        bufp->chgIData(oldp+62,(((4U & vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[8U])
                                  ? ((- (IData)((1U 
        ...
        bufp->chgBit(oldp+63,(((vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U] 
                                >> 0x00000017U) & (
                                                   (0x00400000U 
                                                    & vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U])
                                                    ? 
                                                   ...
                                                   ((0x00200000U 
                                                    ...
                                                    ((0x00100000U 
                                                     ...
                                                     (vlSelfRef.cpu_pipeline_top__DOT__branch_cmp_i__DOT__rs1 
                                                      == vlSelfRef.cpu_pipeline_top__DOT__branch_cmp_i__DOT__rs2)))))));
        bufp->chgIData(oldp+64,((((0x04000000U & vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[6U])
                                   ? ((- (IData)((1U 
                                                  & (~ 
        ...
        bufp->chgBit(oldp+65,(vlSelfRef.cpu_pipeline_top__DOT__data_mem_i__DOT__mem_read));
        bufp->chgBit(oldp+66,(vlSelfRef.cpu_pipeline_top__DOT__data_mem_i__DOT__mem_write));
        bufp->chgCData(oldp+67,((0x0000000fU & (((0x04000000U 
                                                  & vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[6U])
                                                  ? 
        ...
        bufp->chgCData(oldp+68,((0x0000000fU & (((0U 
                                                  == 
                                                  (7U 
                                                   & (vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[6U] 
                                                      >> 0x00000018U)))
        ...
        bufp->chgBit(oldp+69,(vlSelfRef.cpu_pipeline_top__DOT__rvfi_rd_written));
        bufp->chgCData(oldp+70,((0x0000000fU & ((vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[8U] 
                                                 << 1U) 
                                                | (vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U] 
                                                   >> 0x0000001fU)))),4);
        bufp->chgCData(oldp+71,((7U & (vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U] 
                                       >> 0x00000014U))),3);
        bufp->chgBit(oldp+72,((1U & (vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U] 
                                     >> 0x00000017U))));
        bufp->chgBit(oldp+73,(((0x00400000U & vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U])
                                ? ((~ (vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U] 
                                       >> 0x00000015U)) 
                                   & ((0x00100000U 
                                       & vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U])
                                ...
                                : ((0x00200000U & vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U])
                                    ...
                                    : ((0x00100000U 
                                        ...
                                        : (vlSelfRef.cpu_pipeline_top__DOT__branch_cmp_i__DOT__rs1 
                                           == vlSelfRef.cpu_pipeline_top__DOT__branch_cmp_i__DOT__rs2))))));
        bufp->chgIData(oldp+74,(((vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[4U] 
                                  << 0x0000001bU) | 
                                 (vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[3U] 
                                  >> 5U))),32);
        bufp->chgIData(oldp+75,(((vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[3U] 
                                  << 0x0000001bU) | 
                                 (vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[2U] 
                                  >> 5U))),32);
        bufp->chgCData(oldp+76,((7U & (vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[6U] 
                                       >> 0x00000018U))),3);
        bufp->chgSData(oldp+77,((0x000003ffU & (vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[3U] 
                                                >> 7U))),10);
        bufp->chgCData(oldp+78,((3U & (vlSelfRef.cpu_pipeline_top__DOT__ex_mem_q[3U] 
                                       >> 5U))),2);
        bufp->chgIData(oldp+79,(vlSelfRef.cpu_pipeline_top__DOT__if_id_q[0U]),32);
        bufp->chgIData(oldp+80,(((vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[5U] 
                                  << 0x00000011U) | 
                                 (vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[4U] 
                                  >> 0x0000000fU))),32);
        bufp->chgIData(oldp+81,(((vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[4U] 
                                  << 0x00000011U) | 
                                 (vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[3U] 
                                  >> 0x0000000fU))),32);
        bufp->chgBit(oldp+82,((1U & (vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U] 
                                     >> 0x00000012U))));
        bufp->chgBit(oldp+83,((1U & (vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U] 
                                     >> 0x00000013U))));
        bufp->chgIData(oldp+84,(((0x00040000U & vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[7U])
                                  ? vlSelfRef.cpu_pipeline_top__DOT__branch_cmp_i__DOT__rs1
                                  : ((vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[6U] 
                                      << 0x00000011U) 
                                     | (vlSelfRef.cpu_pipeline_top__DOT__id_ex_q[5U] 
                                        >> 0x0000000fU)))),32);
        bufp->chgIData(oldp+85,(vlSelfRef.cpu_pipeline_top__DOT__next_pc_i__DOT__target_raw),32);
        bufp->chgIData(oldp+86,(((0xfffffffeU & vlSelfRef.cpu_pipeline_top__DOT__next_pc_i__DOT__target_raw) 
        ...
        bufp->chgCData(oldp+88,((0x0000001fU & (vlSelfRef.cpu_pipeline_top__DOT__if_id_q[0U] 
                                                >> 0x00000014U))),5);
        bufp->chgCData(oldp+89,((0x0000001fU & (vlSelfRef.cpu_pipeline_top__DOT__mem_wb_q[4U] 
                                                >> 8U))),5);
    }
    bufp->chgBit(oldp+90,(vlSelfRef.clk));
    bufp->chgBit(oldp+91,(vlSelfRef.rst_n));
    bufp->chgIData(oldp+92,(vlSelfRef.instr_out),32);
    bufp->chgBit(oldp+93,(vlSelfRef.halt));
    bufp->chgBit(oldp+94,(vlSelfRef.rvfi_valid));
    bufp->chgIData(oldp+95,(vlSelfRef.rvfi_insn),32);
    bufp->chgIData(oldp+96,(vlSelfRef.rvfi_pc_rdata),32);
    bufp->chgIData(oldp+97,(vlSelfRef.rvfi_pc_wdata),32);
    bufp->chgCData(oldp+98,(vlSelfRef.rvfi_rd_addr),5);
    bufp->chgIData(oldp+99,(vlSelfRef.rvfi_rd_wdata),32);
    bufp->chgIData(oldp+100,(vlSelfRef.rvfi_mem_addr),32);
    bufp->chgCData(oldp+101,(vlSelfRef.rvfi_mem_rmask),4);
    bufp->chgCData(oldp+102,(vlSelfRef.rvfi_mem_wmask),4);
    bufp->chgIData(oldp+103,(vlSelfRef.rvfi_mem_rdata),32);
    bufp->chgIData(oldp+104,(vlSelfRef.rvfi_mem_wdata),32);
    bufp->chgBit(oldp+105,(vlSelfRef.perf_stall));
    bufp->chgBit(oldp+106,(vlSelfRef.perf_flush));
    ...
    __Vtemp_2[4U] = (IData)(((0x0000000200000000ULL 
                              | (QData)((IData)(((IData)(4U) 
                                                 + vlSelfRef.cpu_pipeline_top__DOT__pc_q)))) 
                             >> 0x00000020U));
    bufp->chgWData(oldp+107,(__Vtemp_2),130);
    ...
    __Vtemp_9[8U] = (((0x02000000U & (vlSelfRef.cpu_pipeline_top__DOT__if_id_q[4U] 
                      ...
                      | vlSelfRef.cpu_pipeline_top__DOT__id_ctrl) 
                     >> 0x00000010U);
    bufp->chgWData(oldp+112,(__Vtemp_9),266);
    bufp->chgIData(oldp+121,(((IData)(vlSelfRef.perf_flush)
                               ? vlSelfRef.cpu_pipeline_top__DOT__next_pc_i__DOT__pc_next
                               : ((IData)(4U) + vlSelfRef.cpu_pipeline_top__DOT__pc_q))),32);
    bufp->chgIData(oldp+122,(((((0x0000001fU & (vlSelfRef.cpu_pipeline_top__DOT__if_id_q[0U] 
                                                >> 0x0000000fU)) 
                                == (0x0000001fU & (vlSelfRef.cpu_pipeline_top__DOT__mem_wb_q[4U] 
                                                   >> 8U))) 
                               & (IData)(vlSelfRef.cpu_pipeline_top__DOT__rvfi_rd_written))
    ...
    bufp->chgIData(oldp+123,(((((0x0000001fU & (vlSelfRef.cpu_pipeline_top__DOT__if_id_q[0U] 
                              ...
                              [(0x0000001fU & (vlSelfRef.cpu_pipeline_top__DOT__if_id_q[0U] 
                                               >> 0x00000014U))])),32);
    Vcpu_pipeline_top___024root__trace_chg_dtype____0(vlSelf, bufp, 124, vlSelfRef.cpu_pipeline_top__DOT__reg_file_i__DOT__regs);
}
